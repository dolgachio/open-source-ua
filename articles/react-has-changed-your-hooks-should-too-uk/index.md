## React змінився, ваші хуки теж мають змінитися

Вашій увазі пропонується переклад статті [React Has Changed, Your Hooks Should Too](https://allthingssmitty.com/2025/12/01/react-has-changed-your-hooks-should-too/) авторства Смітті Брауна. Автор **надав дозвіл на публікацію перекладу** в коментарях до оригінальної статті.Переклад підготовлений [dolgachio](https://github.com/dolgachio) для спільноти [Open Source UA 🇺🇦](https://t.me/opensourceua).

🙏 **Величезна подяка** пану [undead404](https://github.com/undead404) за вичитку і виправлення. Саме цей пан стоїть за оцією імбою [koreni.org.ua/](https://koreni.org.ua/). 

> Примітка: Відповідно до правил української мови англійське слово "hooks" має,бути перекладено, як «гаки» або «гачки», або при застосуванні транслітерації має стати словом «гукс» або «гуки». Термін «хуки» є сталим в україномовному ком’юніті реакт-розробників, тож з вашого дозволу, далі ми будемо використовувати саме його. Ця і інші занудні дискусії зазвичай відбуваються в моєму [Threads: @dolgach.io](https://www.threads.com/@dolgach.io)

---

Хуки React (React hooks) з нами вже протягом багатьох років, але більшість проєктів використовують їх однаково: трішки `useState`, роздутий `useEffect`, і купа патернів, які бездумно копіюють з файлу в файл. Ми всі через це проходили.
