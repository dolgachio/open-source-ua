# Фронтенд тренди GitHub #0(Пілотний випуск): десктопний застосунок draw-io, покращення заображень з ШІ, вивчення TypeScript 

Всім привіт, [dolgachio](https://github.com/dolgachio) на звʼязку. Я цікавлюсь опен-сорсом і веду канал [🇺🇦 OpenSourceUA](https://t.me/opensourceua) в Телеграмі.

Щотижня я переглядаю [тренди `GitHub`](https://github.com/trending) в категорії **Frontend(HTML, CSS, JavaScript, TypeScript)** і відбираю найцікавіші проєкти, щоб розповісти про них вам.

## Проєкти, які увійшли в випуск
